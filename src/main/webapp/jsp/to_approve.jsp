...
<body>
     <div region="center" border="false">
        <table class="easyui-datagrid" title="待审批项目" style="width:100%;height:250px"
         ...
         <div class="easyui-panel" title="项目详细信息"  collapsible="true" style="overflow:auto;padding:10px;">
             <h3 style="color:#0099FF;">项目详细信息</h3>
             <p>项目详细信息</p>
         </div>
         <div class="easyui-panel" title="审批信息"  collapsible="true" selected="true" style="padding:10px;">
             审批信息
         </div>
