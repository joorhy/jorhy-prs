...
<body>
    ...
    <div id="tbCommodity" style="height:auto">
        <td align="left">
        <td>商品类预算总价</td>
        <td><input id="commodity_pre_price" class="easyui-textbox" data-options="disabled:true"/></td>
        <td>商品类实际总价</td>
        <td><input id="commodity_total_price" class="easyui-textbox" data-options="disabled:true"/></td>
        </td>
        <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true"
           onclick="viewProjectItem('commodity')">查看</a>
    </div>
    <div id="tbService" style="height:auto">
        <td align="left">
        <td>服务类预算总价</td>
        <td><input id="service_pre_price" class="easyui-textbox" data-options="disabled:true"/></td>
        <td>服务类实际总价</td>
        <td><input id="service_total_price" class="easyui-textbox" data-options="disabled:true"/></td>
        </td>
        <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true"
           onclick="viewProjectItem('service')">查看</a>
    </div>
    <div id="tbEngineering" style="height:auto">
        <td align="left">
        <td>工程类预算总价</td>
        <td><input id="engineering_pre_price" class="easyui-textbox" data-options="disabled:true"/></td>
        <td>工程类实际总价</td>
        <td><input id="engineering_total_price" class="easyui-textbox" data-options="disabled:true"/></td>
        </td>
        <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true"
           onclick="viewProjectItem('engineering')">查看</a>
    </div>
        ...
        <div style="margin:0;padding:20px 50px">
            ...
            <div style="margin-bottom:10px">
                ...
                <input id="prj_spec" class="easyui-textbox" required="true" multiline="true"
                       style="width:100%;height:40px" data-options="disabled:true">
            </div>
            <div style="margin-bottom:10px">
                <td>技术参数及售后</td>
