...
-- 正在导出表  information_schema.CHARACTER_SETS 的数据：-1 rows
...
-- 正在导出表  information_schema.COLLATIONS 的数据：-1 rows
...
-- 正在导出表  information_schema.COLLATION_CHARACTER_SET_APPLICABILITY 的数据：-1 rows
...
-- 正在导出表  information_schema.COLUMNS 的数据：-1 rows
/*!40000 ALTER TABLE `COLUMNS` DISABLE KEYS */;
REPLACE INTO `COLUMNS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `COLUMN_NAME`, `ORDINAL_POSITION`, `COLUMN_DEFAULT`, `IS_NULLABLE`, `DATA_TYPE`, `CHARACTER_MAXIMUM_LENGTH`, `CHARACTER_OCTET_LENGTH`, `NUMERIC_PRECISION`, `NUMERIC_SCALE`, `CHARACTER_SET_NAME`, `COLLATION_NAME`, `COLUMN_TYPE`, `COLUMN_KEY`, `EXTRA`, `PRIVILEGES`, `COLUMN_COMMENT`) VALUES
	...
	(NULL, 'prs', 'approve_record', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	(NULL, 'prs', 'approve_record', 'user_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'approve_record', 'purchase_id', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'approve_record', 'opinion', 4, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'approve_record', 'purchase_activity_id', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'approve_record', 'approve_date', 6, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'dept', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', '部门ID，自增'),
	(NULL, 'prs', 'dept', 'dept_name', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '部门名称'),
	(NULL, 'prs', 'dept', 'dept_code', 3, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '单位编码'),
	(NULL, 'prs', 'directors', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	(NULL, 'prs', 'directors', 'name', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'directors', 'role_id', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'finance_dept', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	(NULL, 'prs', 'finance_dept', 'name', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'finance_dept', 'role_id', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'funds_nature', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	(NULL, 'prs', 'funds_nature', 'name', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'package', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	(NULL, 'prs', 'package', 'package_uuid', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '包ID'),
	(NULL, 'prs', 'package', 'purchase_id', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'package', 'package_name', 4, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '包名'),
	(NULL, 'prs', 'package', 'package_code', 5, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '采购文号'),
	(NULL, 'prs', 'package', 'package_address', 6, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '采购地点'),
	(NULL, 'prs', 'package', 'pur_date', 7, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '采购日期'),
	(NULL, 'prs', 'package', 'expert_count', 8, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '抽取专家人数'),
	(NULL, 'prs', 'package', 'pur_method', 9, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '采购方式'),
	(NULL, 'prs', 'package', 'publicity', 10, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '采购需求公告'),
	(NULL, 'prs', 'package', 'vendor', 11, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '中标供应商'),
	(NULL, 'prs', 'package', 'amount', 12, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '中标金额'),
	(NULL, 'prs', 'package', 'package_activity_id', 13, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'package_activity', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	(NULL, 'prs', 'package_activity', 'status', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'package_attach_file', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	(NULL, 'prs', 'package_attach_file', 'uuid', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'package_attach_file', 'name', 3, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'package_attach_file', 'path', 4, NULL, 'YES', 'varchar', 512, 1536, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(512)', '', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'package_attach_file', 'size', 5, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'package_attach_file', 'package_id', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'package_product', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', '项目ID，自增'),
	(NULL, 'prs', 'package_product', 'uuid', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '项目ID'),
	(NULL, 'prs', 'package_product', 'type', 3, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '项目类别'),
	(NULL, 'prs', 'package_product', 'name', 4, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '项目名称'),
	(NULL, 'prs', 'package_product', 'count', 5, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', '数量'),
	(NULL, 'prs', 'package_product', 'price', 6, NULL, 'YES', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', '单价'),
	(NULL, 'prs', 'package_product', 'spec', 7, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '规格型号'),
	(NULL, 'prs', 'package_product', 'pre_price', 8, NULL, 'YES', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', '预算总价'),
	(NULL, 'prs', 'package_product', 'param', 9, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '技术参数及参数'),
	(NULL, 'prs', 'package_product', 'packaged_count', 10, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '已分包数量'),
	(NULL, 'prs', 'package_product', 'package_id', 11, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'package_record', 'user_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'package_record', 'package_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'package_record', 'id', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	(NULL, 'prs', 'package_record', 'package_activity_id', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'permission', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	(NULL, 'prs', 'permission', 'perm', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'product', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', '项目ID，自增'),
	(NULL, 'prs', 'product', 'uuid', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '项目ID'),
	(NULL, 'prs', 'product', 'type', 3, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '项目类别'),
	(NULL, 'prs', 'product', 'name', 4, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '项目名称'),
	(NULL, 'prs', 'product', 'count', 5, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', '数量'),
	(NULL, 'prs', 'product', 'purchase_id', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'product', 'price', 7, NULL, 'YES', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', '单价'),
	(NULL, 'prs', 'product', 'spec', 8, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '规格型号'),
	(NULL, 'prs', 'product', 'pre_price', 9, NULL, 'YES', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', '预算总价'),
	(NULL, 'prs', 'product', 'param', 10, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '技术参数及参数'),
	(NULL, 'prs', 'product', 'packaged_count', 11, '0', 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', '已分包数量'),
	(NULL, 'prs', 'purchase', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', '采购ID，自增'),
	(NULL, 'prs', 'purchase', 'code', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '采购编号'),
	(NULL, 'prs', 'purchase', 'purchase_uuid', 3, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'purchase', 'name', 4, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'purchase', 'funds_src', 5, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'purchase', 'funds_nature_id', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'purchase', 'contacts', 7, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'purchase', 'phone_num', 8, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'purchase', 'purchase_activity_id', 9, '1', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'purchase_activity', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	(NULL, 'prs', 'purchase_activity', 'status', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'purchase_attach_file', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	(NULL, 'prs', 'purchase_attach_file', 'uuid', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'purchase_attach_file', 'name', 3, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'purchase_attach_file', 'path', 4, NULL, 'YES', 'varchar', 512, 1536, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(512)', '', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'purchase_attach_file', 'size', 5, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'purchase_attach_file', 'purchase_id', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'role', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	(NULL, 'prs', 'role', 'role', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '用户角色\n乡镇：普通职员，单位会计，分管领导-农业局，分管领导-财政局，分管领导-组织部，分管领导-宣传部\n上级：分管股室-农业股，教科文股，投资股，行财股，社保股, \n'),
	(NULL, 'prs', 'role', 'post', 3, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'role', 'user_id', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'role', 'permission_id', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'user', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', '用户ID,自增'),
	(NULL, 'prs', 'user', 'username', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '用户名'),
	(NULL, 'prs', 'user', 'passwd', 3, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '密码'),
	(NULL, 'prs', 'user', 'dept_id', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
	(NULL, 'prs', 'user', 'real_name', 5, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '');
...
-- 正在导出表  information_schema.COLUMN_PRIVILEGES 的数据：-1 rows
...
-- 正在导出表  information_schema.ENGINES 的数据：-1 rows
...
-- 正在导出表  information_schema.EVENTS 的数据：-1 rows
...
-- 正在导出表  information_schema.FILES 的数据：-1 rows
...
-- 正在导出表  information_schema.GLOBAL_STATUS 的数据：-1 rows
...
REPLACE INTO `GLOBAL_STATUS` (`VARIABLE_NAME`, `VARIABLE_VALUE`) VALUES
	...
	('BINLOG_CACHE_USE', '0'),
	('BYTES_RECEIVED', '5821501'),
	('BYTES_SENT', '28135891'),
	('COM_ADMIN_COMMANDS', '1700'),
	...
	('COMPRESSION', 'OFF'),
	('CONNECTIONS', '4553'),
	('CREATED_TMP_DISK_TABLES', '172'),
	('CREATED_TMP_FILES', '5'),
	('CREATED_TMP_TABLES', '9564'),
	('DELAYED_ERRORS', '0'),
	...
	('HANDLER_DISCOVER', '0'),
	('HANDLER_PREPARE', '0'),
	('HANDLER_READ_FIRST', '1096'),
	('HANDLER_READ_KEY', '2050'),
	('HANDLER_READ_NEXT', '170'),
	('HANDLER_READ_PREV', '0'),
	('HANDLER_READ_RND', '0'),
	('HANDLER_READ_RND_NEXT', '677890'),
	('HANDLER_ROLLBACK', '9'),
	('HANDLER_SAVEPOINT', '0'),
	('HANDLER_SAVEPOINT_ROLLBACK', '0'),
	('HANDLER_UPDATE', '26'),
	('HANDLER_WRITE', '663600'),
	('INNODB_BUFFER_POOL_PAGES_DATA', '128'),
	('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
	('INNODB_BUFFER_POOL_PAGES_FLUSHED', '353'),
	('INNODB_BUFFER_POOL_PAGES_FREE', '12991'),
	('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
	('INNODB_BUFFER_POOL_PAGES_TOTAL', '13120'),
	('INNODB_BUFFER_POOL_READ_AHEAD_RND', '2'),
	('INNODB_BUFFER_POOL_READ_AHEAD_SEQ', '0'),
	('INNODB_BUFFER_POOL_READ_REQUESTS', '32954'),
	('INNODB_BUFFER_POOL_READS', '26'),
	('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
	('INNODB_BUFFER_POOL_WRITE_REQUESTS', '1121'),
	('INNODB_DATA_FSYNCS', '314'),
	('INNODB_DATA_PENDING_FSYNCS', '0'),
	('INNODB_DATA_PENDING_READS', '0'),
	('INNODB_DATA_PENDING_WRITES', '0'),
	('INNODB_DATA_READ', '4280320'),
	('INNODB_DATA_READS', '138'),
	('INNODB_DATA_WRITES', '594'),
	('INNODB_DATA_WRITTEN', '11697152'),
	('INNODB_DBLWR_PAGES_WRITTEN', '353'),
	('INNODB_DBLWR_WRITES', '73'),
	('INNODB_LOG_WAITS', '0'),
	('INNODB_LOG_WRITE_REQUESTS', '92'),
	('INNODB_LOG_WRITES', '113'),
	('INNODB_OS_LOG_FSYNCS', '168'),
	('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
	('INNODB_OS_LOG_PENDING_WRITES', '0'),
	('INNODB_OS_LOG_WRITTEN', '101888'),
	('INNODB_PAGE_SIZE', '16384'),
	('INNODB_PAGES_CREATED', '0'),
	('INNODB_PAGES_READ', '128'),
	('INNODB_PAGES_WRITTEN', '353'),
	...
	('THREADS_RUNNING', '1'),
	('UPTIME', '30939'),
	('UPTIME_SINCE_FLUSH_STATUS', '30939');
...
-- 正在导出表  information_schema.GLOBAL_VARIABLES 的数据：-1 rows
...
REPLACE INTO `GLOBAL_VARIABLES` (`VARIABLE_NAME`, `VARIABLE_VALUE`) VALUES
	...
	('REPORT_PORT', '3306'),
	('EXPIRE_LOGS_DAYS', '0'),
	('PID_FILE', 'C:\\ProgramData\\MySQL\\MySQL Server 5.1\\Data\\HICEDP46728.pid'),
	...
	('LOG_ERROR', 'C:\\ProgramData\\MySQL\\MySQL Server 5.1\\Data\\HICEDP46728.err'),
	...
	('HAVE_CSV', 'YES'),
	('INNODB_BUFFER_POOL_SIZE', '214958080'),
	...
	('RELAY_LOG', ''),
	('LC_TIME_NAMES', 'en_US'),
	('PLUGIN_DIR', 'D:\\Program Files\\MySQL\\MySQL Server 5.1\\lib/plugin'),
	('TIMESTAMP', '1475920300'),
	...
	('INNODB_LOG_FILE_SIZE', '108003328'),
...
-- 正在导出表  information_schema.KEY_COLUMN_USAGE 的数据：-1 rows
...
REPLACE INTO `KEY_COLUMN_USAGE` (`CONSTRAINT_CATALOG`, `CONSTRAINT_SCHEMA`, `CONSTRAINT_NAME`, `TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `COLUMN_NAME`, `ORDINAL_POSITION`, `POSITION_IN_UNIQUE_CONSTRAINT`, `REFERENCED_TABLE_SCHEMA`, `REFERENCED_TABLE_NAME`, `REFERENCED_COLUMN_NAME`) VALUES
	...
	(NULL, 'prs', 'PRIMARY', NULL, 'prs', 'approve_record', 'id', 1, NULL, NULL, NULL, NULL),
	(NULL, 'prs', 'fk_approve_record_pruchase_activity1', NULL, 'prs', 'approve_record', 'purchase_activity_id', 1, 1, 'prs', 'purchase_activity', 'id'),
	(NULL, 'prs', 'fk_approve_record_purchase1', NULL, 'prs', 'approve_record', 'purchase_id', 1, 1, 'prs', 'purchase', 'id'),
	(NULL, 'prs', 'fk_approve_record_user1', NULL, 'prs', 'approve_record', 'user_id', 1, 1, 'prs', 'user', 'id'),
	(NULL, 'prs', 'PRIMARY', NULL, 'prs', 'dept', 'id', 1, NULL, NULL, NULL, NULL),
	(NULL, 'prs', 'PRIMARY', NULL, 'prs', 'directors', 'id', 1, NULL, NULL, NULL, NULL),
	(NULL, 'prs', 'fk_directors_role1', NULL, 'prs', 'directors', 'role_id', 1, 1, 'prs', 'role', 'id'),
	(NULL, 'prs', 'PRIMARY', NULL, 'prs', 'finance_dept', 'id', 1, NULL, NULL, NULL, NULL),
	(NULL, 'prs', 'fk_finance_dept_role1', NULL, 'prs', 'finance_dept', 'role_id', 1, 1, 'prs', 'role', 'id'),
	(NULL, 'prs', 'PRIMARY', NULL, 'prs', 'funds_nature', 'id', 1, NULL, NULL, NULL, NULL),
	(NULL, 'prs', 'PRIMARY', NULL, 'prs', 'package', 'id', 1, NULL, NULL, NULL, NULL),
	(NULL, 'prs', 'fk_package_package_activity1', NULL, 'prs', 'package', 'package_activity_id', 1, 1, 'prs', 'package_activity', 'id'),
	(NULL, 'prs', 'fk_package_purchase1', NULL, 'prs', 'package', 'purchase_id', 1, 1, 'prs', 'purchase', 'id'),
	(NULL, 'prs', 'PRIMARY', NULL, 'prs', 'package_activity', 'id', 1, NULL, NULL, NULL, NULL),
	(NULL, 'prs', 'PRIMARY', NULL, 'prs', 'package_attach_file', 'id', 1, NULL, NULL, NULL, NULL),
	(NULL, 'prs', 'fk_package_attach_file_package1', NULL, 'prs', 'package_attach_file', 'package_id', 1, 1, 'prs', 'package', 'id'),
	(NULL, 'prs', 'PRIMARY', NULL, 'prs', 'package_product', 'id', 1, NULL, NULL, NULL, NULL),
	(NULL, 'prs', 'fk_product_copy1_package1', NULL, 'prs', 'package_product', 'package_id', 1, 1, 'prs', 'package', 'id'),
	(NULL, 'prs', 'PRIMARY', NULL, 'prs', 'package_record', 'id', 1, NULL, NULL, NULL, NULL),
	(NULL, 'prs', 'fk_package_record_package1', NULL, 'prs', 'package_record', 'package_id', 1, 1, 'prs', 'package', 'id'),
	(NULL, 'prs', 'fk_package_record_package_activity1', NULL, 'prs', 'package_record', 'package_activity_id', 1, 1, 'prs', 'package_activity', 'id'),
	(NULL, 'prs', 'fk_package_record_user1', NULL, 'prs', 'package_record', 'user_id', 1, 1, 'prs', 'user', 'id'),
	(NULL, 'prs', 'PRIMARY', NULL, 'prs', 'permission', 'id', 1, NULL, NULL, NULL, NULL),
	(NULL, 'prs', 'PRIMARY', NULL, 'prs', 'product', 'id', 1, NULL, NULL, NULL, NULL),
	(NULL, 'prs', 'fk_product_purchase1', NULL, 'prs', 'product', 'purchase_id', 1, 1, 'prs', 'purchase', 'id'),
	(NULL, 'prs', 'PRIMARY', NULL, 'prs', 'purchase', 'id', 1, NULL, NULL, NULL, NULL),
	(NULL, 'prs', 'fk_purchase_funds_nature1', NULL, 'prs', 'purchase', 'funds_nature_id', 1, 1, 'prs', 'funds_nature', 'id'),
	(NULL, 'prs', 'fk_purchase_pruchase_activity1', NULL, 'prs', 'purchase', 'purchase_activity_id', 1, 1, 'prs', 'purchase_activity', 'id'),
	(NULL, 'prs', 'PRIMARY', NULL, 'prs', 'purchase_activity', 'id', 1, NULL, NULL, NULL, NULL),
	(NULL, 'prs', 'PRIMARY', NULL, 'prs', 'purchase_attach_file', 'id', 1, NULL, NULL, NULL, NULL),
	(NULL, 'prs', 'fk_purchase_attach_file_purchase1', NULL, 'prs', 'purchase_attach_file', 'purchase_id', 1, 1, 'prs', 'purchase', 'id'),
	(NULL, 'prs', 'PRIMARY', NULL, 'prs', 'role', 'id', 1, NULL, NULL, NULL, NULL),
	(NULL, 'prs', 'fk_role_permission1', NULL, 'prs', 'role', 'permission_id', 1, 1, 'prs', 'permission', 'id'),
	(NULL, 'prs', 'fk_role_user1', NULL, 'prs', 'role', 'user_id', 1, 1, 'prs', 'user', 'id'),
	(NULL, 'prs', 'PRIMARY', NULL, 'prs', 'user', 'id', 1, NULL, NULL, NULL, NULL),
	(NULL, 'prs', 'fk_user_dept', NULL, 'prs', 'user', 'dept_id', 1, 1, 'prs', 'dept', 'id');
...
-- 正在导出表  information_schema.PARTITIONS 的数据：-1 rows
...
REPLACE INTO `PARTITIONS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `PARTITION_NAME`, `SUBPARTITION_NAME`, `PARTITION_ORDINAL_POSITION`, `SUBPARTITION_ORDINAL_POSITION`, `PARTITION_METHOD`, `SUBPARTITION_METHOD`, `PARTITION_EXPRESSION`, `SUBPARTITION_EXPRESSION`, `PARTITION_DESCRIPTION`, `TABLE_ROWS`, `AVG_ROW_LENGTH`, `DATA_LENGTH`, `MAX_DATA_LENGTH`, `INDEX_LENGTH`, `DATA_FREE`, `CREATE_TIME`, `UPDATE_TIME`, `CHECK_TIME`, `CHECKSUM`, `PARTITION_COMMENT`, `NODEGROUP`, `TABLESPACE_NAME`) VALUES
	(NULL, 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16434816, 0, 0, '2016-10-08 17:51:40', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2016-10-08 17:51:40', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16357770, 0, 0, '2016-10-08 17:51:40', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-10-08 17:51:40', '2016-10-08 17:51:40', NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2016-10-08 17:51:40', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16574250, 0, 0, '2016-10-08 17:51:40', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-10-08 17:51:40', '2016-10-08 17:51:40', NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2016-10-08 17:51:40', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2016-10-08 17:51:40', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2016-10-08 17:51:40', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2016-10-08 17:51:40', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-10-08 17:51:40', '2016-10-08 17:51:40', NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-10-08 17:51:40', '2016-10-08 17:51:40', NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-10-08 17:51:40', '2016-10-08 17:51:40', NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2016-10-08 17:51:40', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2016-10-08 17:51:40', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-10-08 17:51:40', '2016-10-08 17:51:40', NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16738048, 0, 0, '2016-10-08 17:51:40', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16736899, 0, 0, '2016-10-08 17:51:40', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2016-10-08 17:51:40', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2016-10-08 17:51:40', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2679, 0, 16770540, 0, 0, '2016-10-08 17:51:40', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3545, 0, 16743035, 0, 0, '2016-10-08 17:51:40', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16721712, 0, 0, '2016-10-08 17:51:40', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2016-10-08 17:51:40', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-10-08 17:51:40', '2016-10-08 17:51:40', NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16726092, 0, 0, '2016-10-08 17:51:40', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-10-08 17:51:40', '2016-10-08 17:51:40', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2013-11-05 03:09:06', '2013-11-04 20:09:06', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 880, 123848989752688639, 5120, 880, '2013-11-05 03:09:06', '2015-07-27 10:23:52', '2013-11-05 03:09:07', NULL, '', '', NULL),
	(NULL, 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2013-11-05 03:09:07', '2013-11-04 20:09:08', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2013-11-05 03:09:06', '2013-11-04 20:09:06', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 40, 28, 1120, 281474976710655, 3072, 0, '2013-11-05 03:09:06', '2013-11-04 20:09:08', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 453, 197, 89241, 55450570411999231, 16384, 0, '2013-11-05 03:09:06', '2013-11-04 20:09:08', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1009, 9, 9081, 2533274790395903, 17408, 0, '2013-11-05 03:09:06', '2013-11-04 20:09:08', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 510, 910, 464340, 281474976710655, 20480, 0, '2013-11-05 03:09:06', '2013-11-04 20:09:08', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2013-11-05 03:09:06', '2013-11-04 20:09:06', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-11-05 03:09:07', '2013-11-04 20:09:08', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162411061562048511, 1024, 0, '2013-11-05 03:09:06', '2013-11-04 20:09:06', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2013-11-05 03:09:07', '2013-11-04 20:09:08', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2013-11-05 03:09:07', '2013-11-04 20:09:08', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2013-11-05 03:09:06', '2013-11-04 20:09:06', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2013-11-05 03:09:06', '2013-11-04 20:09:06', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2013-11-05 03:09:06', '2013-11-04 20:09:06', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2013-11-05 03:09:06', '2013-11-04 20:09:06', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2013-11-05 03:09:06', '2013-11-04 20:09:06', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2013-11-05 03:09:06', '2013-11-04 20:09:06', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2013-11-05 03:09:06', '2013-11-04 20:09:06', NULL, NULL, '', '', NULL),
	(NULL, 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 104, 256, 281474976710655, 2048, 152, '2013-11-05 03:09:06', '2015-07-27 09:54:11', NULL, NULL, '', '', NULL),
	(NULL, 'prs', 'approve_record', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, 1820, 16384, NULL, 49152, 11534336, '2016-09-08 16:21:14', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'prs', 'dept', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 11534336, '2016-07-08 13:53:31', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'prs', 'directors', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 16384, 11534336, '2016-09-09 10:07:28', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'prs', 'finance_dept', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 3276, 16384, NULL, 16384, 11534336, '2016-09-09 09:59:33', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'prs', 'funds_nature', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 0, 11534336, '2016-09-09 14:30:34', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'prs', 'package', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 11534336, '2016-09-08 16:22:08', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'prs', 'package_activity', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 11534336, '2016-09-23 16:24:28', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'prs', 'package_attach_file', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 11534336, '2016-09-23 11:25:01', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'prs', 'package_product', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 11534336, '2016-09-23 21:22:15', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'prs', 'package_record', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 49152, 11534336, '2016-09-23 16:24:28', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'prs', 'permission', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7, 2340, 16384, NULL, 0, 11534336, '2016-09-09 14:01:12', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'prs', 'product', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 16384, 11534336, '2016-09-09 09:47:59', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'prs', 'purchase', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 3276, 16384, NULL, 32768, 11534336, '2016-09-09 14:25:17', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'prs', 'purchase_activity', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8, 2048, 16384, NULL, 0, 11534336, '2016-10-08 13:48:38', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'prs', 'purchase_attach_file', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 16384, 11534336, '2016-09-09 16:03:50', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'prs', 'role', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 14, 1170, 16384, NULL, 32768, 11534336, '2016-09-08 16:21:14', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'prs', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 14, 1170, 16384, NULL, 16384, 11534336, '2016-07-08 13:53:31', NULL, NULL, NULL, '', '', NULL);
...
-- 正在导出表  information_schema.PLUGINS 的数据：-1 rows
/*!40000 ALTER TABLE `PLUGINS` DISABLE KEYS */;
REPLACE INTO `PLUGINS` (`PLUGIN_NAME`, `PLUGIN_VERSION`, `PLUGIN_STATUS`, `PLUGIN_TYPE`, `PLUGIN_TYPE_VERSION`, `PLUGIN_LIBRARY`, `PLUGIN_LIBRARY_VERSION`, `PLUGIN_AUTHOR`, `PLUGIN_DESCRIPTION`, `PLUGIN_LICENSE`) VALUES
...
-- 正在导出表  information_schema.PROCESSLIST 的数据：-1 rows
/*!40000 ALTER TABLE `PROCESSLIST` DISABLE KEYS */;
REPLACE INTO `PROCESSLIST` (`ID`, `USER`, `HOST`, `DB`, `COMMAND`, `TIME`, `STATE`, `INFO`) VALUES
	(4552, 'root', 'localhost:57244', 'prs', 'Sleep', 3, '', NULL),
	(4551, 'root', 'localhost:57243', 'prs', 'Sleep', 3, '', NULL),
	(4550, 'root', 'localhost:57242', 'prs', 'Sleep', 3, '', NULL),
	(4549, 'root', 'localhost:57241', 'prs', 'Sleep', 3, '', NULL),
	(4548, 'root', 'localhost:57240', 'prs', 'Sleep', 3, '', NULL),
	(4547, 'root', 'localhost:57238', 'prs', 'Sleep', 3, '', NULL),
	(4546, 'root', 'localhost:57239', 'prs', 'Sleep', 3, '', NULL),
	(4545, 'root', 'localhost:57236', 'prs', 'Sleep', 23, '', NULL),
	(4544, 'root', 'localhost:57235', 'prs', 'Sleep', 23, '', NULL),
	(4543, 'root', 'localhost:57237', 'prs', 'Sleep', 23, '', NULL),
	(31, 'root', 'localhost:50436', 'prs', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST` LIMIT 104857600');
...
-- 正在导出表  information_schema.PROFILING 的数据：-1 rows
...
-- 正在导出表  information_schema.REFERENTIAL_CONSTRAINTS 的数据：-1 rows
...
REPLACE INTO `REFERENTIAL_CONSTRAINTS` (`CONSTRAINT_CATALOG`, `CONSTRAINT_SCHEMA`, `CONSTRAINT_NAME`, `UNIQUE_CONSTRAINT_CATALOG`, `UNIQUE_CONSTRAINT_SCHEMA`, `UNIQUE_CONSTRAINT_NAME`, `MATCH_OPTION`, `UPDATE_RULE`, `DELETE_RULE`, `TABLE_NAME`, `REFERENCED_TABLE_NAME`) VALUES
	(NULL, 'prs', 'fk_approve_record_pruchase_activity1', NULL, 'prs', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'approve_record', 'purchase_activity'),
	(NULL, 'prs', 'fk_approve_record_purchase1', NULL, 'prs', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'approve_record', 'purchase'),
	(NULL, 'prs', 'fk_approve_record_user1', NULL, 'prs', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'approve_record', 'user'),
	(NULL, 'prs', 'fk_directors_role1', NULL, 'prs', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'directors', 'role'),
	(NULL, 'prs', 'fk_finance_dept_role1', NULL, 'prs', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'finance_dept', 'role'),
	(NULL, 'prs', 'fk_package_package_activity1', NULL, 'prs', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'package', 'package_activity'),
	(NULL, 'prs', 'fk_package_purchase1', NULL, 'prs', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'package', 'purchase'),
	(NULL, 'prs', 'fk_package_attach_file_package1', NULL, 'prs', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'package_attach_file', 'package'),
	(NULL, 'prs', 'fk_product_copy1_package1', NULL, 'prs', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'package_product', 'package'),
	(NULL, 'prs', 'fk_package_record_package1', NULL, 'prs', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'package_record', 'package'),
	(NULL, 'prs', 'fk_package_record_package_activity1', NULL, 'prs', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'package_record', 'package_activity'),
	(NULL, 'prs', 'fk_package_record_user1', NULL, 'prs', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'package_record', 'user'),
	(NULL, 'prs', 'fk_product_purchase1', NULL, 'prs', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'product', 'purchase'),
	(NULL, 'prs', 'fk_purchase_funds_nature1', NULL, 'prs', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'purchase', 'funds_nature'),
	(NULL, 'prs', 'fk_purchase_pruchase_activity1', NULL, 'prs', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'purchase', 'purchase_activity'),
	(NULL, 'prs', 'fk_purchase_attach_file_purchase1', NULL, 'prs', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'purchase_attach_file', 'purchase'),
	(NULL, 'prs', 'fk_role_permission1', NULL, 'prs', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'role', 'permission'),
	(NULL, 'prs', 'fk_role_user1', NULL, 'prs', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'role', 'user'),
	(NULL, 'prs', 'fk_user_dept', NULL, 'prs', 'PRIMARY', 'NONE', 'NO ACTION', 'NO ACTION', 'user', 'dept');
...
-- 正在导出表  information_schema.ROUTINES 的数据：-1 rows
...
-- 正在导出表  information_schema.SCHEMATA 的数据：-1 rows
...
REPLACE INTO `SCHEMATA` (`CATALOG_NAME`, `SCHEMA_NAME`, `DEFAULT_CHARACTER_SET_NAME`, `DEFAULT_COLLATION_NAME`, `SQL_PATH`) VALUES
	...
	(NULL, 'prs', 'utf8', 'utf8_general_ci', NULL),
...
-- 正在导出表  information_schema.SCHEMA_PRIVILEGES 的数据：-1 rows
...
-- 正在导出表  information_schema.SESSION_STATUS 的数据：-1 rows
...
REPLACE INTO `SESSION_STATUS` (`VARIABLE_NAME`, `VARIABLE_VALUE`) VALUES
	...
	('BINLOG_CACHE_DISK_USE', '0'),
	('BINLOG_CACHE_USE', '0'),
	('BYTES_RECEIVED', '35604'),
	('BYTES_SENT', '405405'),
	('COM_ADMIN_COMMANDS', '1744'),
	('COM_ASSIGN_TO_KEYCACHE', '0'),
	('COM_ALTER_DB', '0'),
	('COM_ALTER_DB_UPGRADE', '0'),
	('COM_ALTER_EVENT', '0'),
	...
	('HANDLER_DISCOVER', '0'),
	('HANDLER_PREPARE', '0'),
	('HANDLER_READ_FIRST', '98'),
	('HANDLER_READ_KEY', '107'),
	('HANDLER_READ_NEXT', '0'),
	('HANDLER_READ_PREV', '0'),
	('HANDLER_READ_RND', '0'),
	('HANDLER_READ_RND_NEXT', '2930'),
	('HANDLER_ROLLBACK', '1'),
	('HANDLER_SAVEPOINT', '0'),
	('HANDLER_SAVEPOINT_ROLLBACK', '0'),
	('HANDLER_UPDATE', '3'),
	...
	('INNODB_BUFFER_POOL_READ_AHEAD_RND', '2'),
	('INNODB_BUFFER_POOL_READ_AHEAD_SEQ', '0'),
	('INNODB_BUFFER_POOL_READ_REQUESTS', '33710'),
	('INNODB_BUFFER_POOL_READS', '26'),
	('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
	('INNODB_BUFFER_POOL_WRITE_REQUESTS', '1121'),
	('INNODB_DATA_FSYNCS', '314'),
...
-- 正在导出表  information_schema.SESSION_VARIABLES 的数据：-1 rows
...
-- 正在导出表  information_schema.STATISTICS 的数据：-1 rows
/*!40000 ALTER TABLE `STATISTICS` DISABLE KEYS */;
REPLACE INTO `STATISTICS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `NON_UNIQUE`, `INDEX_SCHEMA`, `INDEX_NAME`, `SEQ_IN_INDEX`, `COLUMN_NAME`, `COLLATION`, `CARDINALITY`, `SUB_PART`, `PACKED`, `NULLABLE`, `INDEX_TYPE`, `COMMENT`) VALUES
	...
	(NULL, 'mysql', 'help_relation', 0, 'mysql', 'PRIMARY', 2, 'help_topic_id', 'A', 1009, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'mysql', 'help_topic', 0, 'mysql', 'PRIMARY', 1, 'help_topic_id', 'A', 510, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'mysql', 'help_topic', 0, 'mysql', 'name', 1, 'name', 'A', 510, NULL, NULL, '', 'BTREE', ''),
	...
	(NULL, 'prs', 'approve_record', 0, 'prs', 'PRIMARY', 1, 'id', 'A', 9, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'approve_record', 1, 'prs', 'fk_approve_record_user1_idx', 1, 'user_id', 'A', 9, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'approve_record', 1, 'prs', 'fk_approve_record_purchase1_idx', 1, 'purchase_id', 'A', 9, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'approve_record', 1, 'prs', 'fk_approve_record_pruchase_activity1_idx', 1, 'purchase_activity_id', 'A', 9, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'dept', 0, 'prs', 'PRIMARY', 1, 'id', 'A', 3, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'directors', 0, 'prs', 'PRIMARY', 1, 'id', 'A', 4, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'directors', 1, 'prs', 'fk_directors_role1_idx', 1, 'role_id', 'A', 4, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'finance_dept', 0, 'prs', 'PRIMARY', 1, 'id', 'A', 5, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'finance_dept', 1, 'prs', 'fk_finance_dept_role1_idx', 1, 'role_id', 'A', 5, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'funds_nature', 0, 'prs', 'PRIMARY', 1, 'id', 'A', 4, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'package', 0, 'prs', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'package', 1, 'prs', 'fk_package_purchase1_idx', 1, 'purchase_id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'package', 1, 'prs', 'fk_package_package_activity1_idx', 1, 'package_activity_id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'package_activity', 0, 'prs', 'PRIMARY', 1, 'id', 'A', 3, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'package_attach_file', 0, 'prs', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'package_attach_file', 1, 'prs', 'fk_package_attach_file_package1_idx', 1, 'package_id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'package_product', 0, 'prs', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'package_product', 1, 'prs', 'fk_product_copy1_package1_idx', 1, 'package_id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'package_record', 0, 'prs', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'package_record', 1, 'prs', 'fk_package_record_user1_idx', 1, 'user_id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'package_record', 1, 'prs', 'fk_package_record_package1_idx', 1, 'package_id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'package_record', 1, 'prs', 'fk_package_record_package_activity1_idx', 1, 'package_activity_id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'permission', 0, 'prs', 'PRIMARY', 1, 'id', 'A', 7, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'product', 0, 'prs', 'PRIMARY', 1, 'id', 'A', 3, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'product', 1, 'prs', 'fk_product_purchase1_idx', 1, 'purchase_id', 'A', 3, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'purchase', 0, 'prs', 'PRIMARY', 1, 'id', 'A', 5, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'purchase', 1, 'prs', 'fk_purchase_funds_nature1_idx', 1, 'funds_nature_id', 'A', 5, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'purchase', 1, 'prs', 'fk_purchase_pruchase_activity1_idx', 1, 'purchase_activity_id', 'A', 5, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'purchase_activity', 0, 'prs', 'PRIMARY', 1, 'id', 'A', 8, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'purchase_attach_file', 0, 'prs', 'PRIMARY', 1, 'id', 'A', 1, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'purchase_attach_file', 1, 'prs', 'fk_purchase_attach_file_purchase1_idx', 1, 'purchase_id', 'A', 1, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'role', 0, 'prs', 'PRIMARY', 1, 'id', 'A', 14, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'role', 1, 'prs', 'fk_role_user1_idx', 1, 'user_id', 'A', 14, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'role', 1, 'prs', 'fk_role_permission1_idx', 1, 'permission_id', 'A', 14, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'user', 0, 'prs', 'PRIMARY', 1, 'id', 'A', 14, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'user', 1, 'prs', 'fk_user_dept_idx', 1, 'dept_id', 'A', 7, NULL, NULL, '', 'BTREE', '');
...
-- 正在导出表  information_schema.TABLES 的数据：-1 rows
/*!40000 ALTER TABLE `TABLES` DISABLE KEYS */;
REPLACE INTO `TABLES` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `TABLE_TYPE`, `ENGINE`, `VERSION`, `ROW_FORMAT`, `TABLE_ROWS`, `AVG_ROW_LENGTH`, `DATA_LENGTH`, `MAX_DATA_LENGTH`, `INDEX_LENGTH`, `DATA_FREE`, `AUTO_INCREMENT`, `CREATE_TIME`, `UPDATE_TIME`, `CHECK_TIME`, `TABLE_COLLATION`, `CHECKSUM`, `CREATE_OPTIONS`, `TABLE_COMMENT`) VALUES
	(NULL, 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16434816, 0, 0, NULL, '2016-10-08 17:51:40', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
	(NULL, 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2016-10-08 17:51:40', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
	(NULL, 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16357770, 0, 0, NULL, '2016-10-08 17:51:40', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
	(NULL, 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-10-08 17:51:40', '2016-10-08 17:51:40', NULL, 'utf8_general_ci', NULL, 'max_rows=9690', ''),
	(NULL, 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2016-10-08 17:51:40', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
	(NULL, 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16574250, 0, 0, NULL, '2016-10-08 17:51:40', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
	(NULL, 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-10-08 17:51:40', '2016-10-08 17:51:40', NULL, 'utf8_general_ci', NULL, 'max_rows=1315', ''),
	(NULL, 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2016-10-08 17:51:40', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
	(NULL, 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2016-10-08 17:51:40', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
	(NULL, 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2016-10-08 17:51:40', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
	(NULL, 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2016-10-08 17:51:40', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
	(NULL, 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-10-08 17:51:40', '2016-10-08 17:51:40', NULL, 'utf8_general_ci', NULL, 'max_rows=11927', ''),
	(NULL, 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-10-08 17:51:40', '2016-10-08 17:51:40', NULL, 'utf8_general_ci', NULL, 'max_rows=27679', ''),
	(NULL, 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-10-08 17:51:40', '2016-10-08 17:51:40', NULL, 'utf8_general_ci', NULL, 'max_rows=50785', ''),
	(NULL, 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2016-10-08 17:51:40', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
	(NULL, 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2016-10-08 17:51:40', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
	(NULL, 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-10-08 17:51:40', '2016-10-08 17:51:40', NULL, 'utf8_general_ci', NULL, 'max_rows=1250', ''),
	(NULL, 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16738048, 0, 0, NULL, '2016-10-08 17:51:40', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
	(NULL, 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16736899, 0, 0, NULL, '2016-10-08 17:51:40', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
	(NULL, 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2016-10-08 17:51:40', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
	(NULL, 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2016-10-08 17:51:40', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
	(NULL, 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2679, 0, 16770540, 0, 0, NULL, '2016-10-08 17:51:40', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6262', ''),
	(NULL, 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3545, 0, 16743035, 0, 0, NULL, '2016-10-08 17:51:40', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4732', ''),
	(NULL, 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16721712, 0, 0, NULL, '2016-10-08 17:51:40', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
	(NULL, 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2016-10-08 17:51:40', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
	(NULL, 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-10-08 17:51:40', '2016-10-08 17:51:40', NULL, 'utf8_general_ci', NULL, 'max_rows=1210', ''),
	(NULL, 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16726092, 0, 0, NULL, '2016-10-08 17:51:40', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
	(NULL, 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-10-08 17:51:40', '2016-10-08 17:51:40', NULL, 'utf8_general_ci', NULL, 'max_rows=14732', ''),
	(NULL, 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2013-11-05 03:09:06', '2013-11-04 20:09:06', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
	(NULL, 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 880, 123848989752688639, 5120, 880, NULL, '2013-11-05 03:09:06', '2015-07-27 10:23:52', '2013-11-05 03:09:07', 'utf8_bin', NULL, '', 'Database privileges'),
	(NULL, 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2013-11-05 03:09:07', '2013-11-04 20:09:08', NULL, 'utf8_general_ci', NULL, '', 'Events'),
	(NULL, 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2013-11-05 03:09:06', '2013-11-04 20:09:06', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
	(NULL, 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
	(NULL, 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 40, 28, 1120, 281474976710655, 3072, 0, NULL, '2013-11-05 03:09:06', '2013-11-04 20:09:08', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
	(NULL, 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 453, 197, 89241, 55450570411999231, 16384, 0, NULL, '2013-11-05 03:09:06', '2013-11-04 20:09:08', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
	(NULL, 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1009, 9, 9081, 2533274790395903, 17408, 0, NULL, '2013-11-05 03:09:06', '2013-11-04 20:09:08', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
	(NULL, 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 510, 910, 464340, 281474976710655, 20480, 0, NULL, '2013-11-05 03:09:06', '2013-11-04 20:09:08', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
	(NULL, 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2013-11-05 03:09:06', '2013-11-04 20:09:06', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
	(NULL, 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2013-11-05 03:09:07', '2013-11-04 20:09:08', NULL, 'latin1_swedish_ci', NULL, '', ''),
	(NULL, 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162411061562048511, 1024, 0, NULL, '2013-11-05 03:09:06', '2013-11-04 20:09:06', NULL, 'utf8_bin', NULL, '', 'MySQL plugins'),
	(NULL, 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2013-11-05 03:09:07', '2013-11-04 20:09:08', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
	(NULL, 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2013-11-05 03:09:07', '2013-11-04 20:09:08', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
	(NULL, 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2013-11-05 03:09:06', '2013-11-04 20:09:06', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
	(NULL, 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
	(NULL, 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2013-11-05 03:09:06', '2013-11-04 20:09:06', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
	(NULL, 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2013-11-05 03:09:06', '2013-11-04 20:09:06', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
	(NULL, 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2013-11-05 03:09:06', '2013-11-04 20:09:06', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
	(NULL, 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2013-11-05 03:09:06', '2013-11-04 20:09:06', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
	(NULL, 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2013-11-05 03:09:06', '2013-11-04 20:09:06', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
	(NULL, 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2013-11-05 03:09:06', '2013-11-04 20:09:06', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
	(NULL, 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 104, 256, 281474976710655, 2048, 152, NULL, '2013-11-05 03:09:06', '2015-07-27 09:54:11', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
	(NULL, 'prs', 'approve_record', 'BASE TABLE', 'InnoDB', 10, 'Compact', 9, 1820, 16384, 0, 49152, 11534336, 13, '2016-09-08 16:21:14', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
	(NULL, 'prs', 'dept', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 11534336, 4, '2016-07-08 13:53:31', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
	(NULL, 'prs', 'directors', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 16384, 11534336, 5, '2016-09-09 10:07:28', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
	(NULL, 'prs', 'finance_dept', 'BASE TABLE', 'InnoDB', 10, 'Compact', 5, 3276, 16384, 0, 16384, 11534336, 6, '2016-09-09 09:59:33', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
	(NULL, 'prs', 'funds_nature', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 11534336, 5, '2016-09-09 14:30:34', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
	(NULL, 'prs', 'package', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 11534336, 1, '2016-09-08 16:22:08', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
	(NULL, 'prs', 'package_activity', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 11534336, 4, '2016-09-23 16:24:28', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
	(NULL, 'prs', 'package_attach_file', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 11534336, 1, '2016-09-23 11:25:01', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
	(NULL, 'prs', 'package_product', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 11534336, 1, '2016-09-23 21:22:15', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
	(NULL, 'prs', 'package_record', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 49152, 11534336, 1, '2016-09-23 16:24:28', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
	(NULL, 'prs', 'permission', 'BASE TABLE', 'InnoDB', 10, 'Compact', 7, 2340, 16384, 0, 0, 11534336, 8, '2016-09-09 14:01:12', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
	(NULL, 'prs', 'product', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 16384, 11534336, 6, '2016-09-09 09:47:59', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
	(NULL, 'prs', 'purchase', 'BASE TABLE', 'InnoDB', 10, 'Compact', 5, 3276, 16384, 0, 32768, 11534336, 7, '2016-09-09 14:25:17', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
	(NULL, 'prs', 'purchase_activity', 'BASE TABLE', 'InnoDB', 10, 'Compact', 8, 2048, 16384, 0, 0, 11534336, 9, '2016-10-08 13:48:38', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
	(NULL, 'prs', 'purchase_attach_file', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 16384, 11534336, 2, '2016-09-09 16:03:50', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
	(NULL, 'prs', 'role', 'BASE TABLE', 'InnoDB', 10, 'Compact', 14, 1170, 16384, 0, 32768, 11534336, 15, '2016-09-08 16:21:14', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
	(NULL, 'prs', 'user', 'BASE TABLE', 'InnoDB', 10, 'Compact', 14, 1170, 16384, 0, 16384, 11534336, 15, '2016-07-08 13:53:31', NULL, NULL, 'utf8_general_ci', NULL, '', '');
...
-- 正在导出表  information_schema.TABLE_CONSTRAINTS 的数据：-1 rows
...
REPLACE INTO `TABLE_CONSTRAINTS` (`CONSTRAINT_CATALOG`, `CONSTRAINT_SCHEMA`, `CONSTRAINT_NAME`, `TABLE_SCHEMA`, `TABLE_NAME`, `CONSTRAINT_TYPE`) VALUES
	...
	(NULL, 'prs', 'PRIMARY', 'prs', 'approve_record', 'PRIMARY KEY'),
	(NULL, 'prs', 'fk_approve_record_pruchase_activity1', 'prs', 'approve_record', 'FOREIGN KEY'),
	(NULL, 'prs', 'fk_approve_record_purchase1', 'prs', 'approve_record', 'FOREIGN KEY'),
	(NULL, 'prs', 'fk_approve_record_user1', 'prs', 'approve_record', 'FOREIGN KEY'),
	(NULL, 'prs', 'PRIMARY', 'prs', 'dept', 'PRIMARY KEY'),
	(NULL, 'prs', 'PRIMARY', 'prs', 'directors', 'PRIMARY KEY'),
	(NULL, 'prs', 'fk_directors_role1', 'prs', 'directors', 'FOREIGN KEY'),
	(NULL, 'prs', 'PRIMARY', 'prs', 'finance_dept', 'PRIMARY KEY'),
	(NULL, 'prs', 'fk_finance_dept_role1', 'prs', 'finance_dept', 'FOREIGN KEY'),
	(NULL, 'prs', 'PRIMARY', 'prs', 'funds_nature', 'PRIMARY KEY'),
	(NULL, 'prs', 'PRIMARY', 'prs', 'package', 'PRIMARY KEY'),
	(NULL, 'prs', 'fk_package_package_activity1', 'prs', 'package', 'FOREIGN KEY'),
	(NULL, 'prs', 'fk_package_purchase1', 'prs', 'package', 'FOREIGN KEY'),
	(NULL, 'prs', 'PRIMARY', 'prs', 'package_activity', 'PRIMARY KEY'),
	(NULL, 'prs', 'PRIMARY', 'prs', 'package_attach_file', 'PRIMARY KEY'),
	(NULL, 'prs', 'fk_package_attach_file_package1', 'prs', 'package_attach_file', 'FOREIGN KEY'),
	(NULL, 'prs', 'PRIMARY', 'prs', 'package_product', 'PRIMARY KEY'),
	(NULL, 'prs', 'fk_product_copy1_package1', 'prs', 'package_product', 'FOREIGN KEY'),
	(NULL, 'prs', 'PRIMARY', 'prs', 'package_record', 'PRIMARY KEY'),
	(NULL, 'prs', 'fk_package_record_package1', 'prs', 'package_record', 'FOREIGN KEY'),
	(NULL, 'prs', 'fk_package_record_package_activity1', 'prs', 'package_record', 'FOREIGN KEY'),
	(NULL, 'prs', 'fk_package_record_user1', 'prs', 'package_record', 'FOREIGN KEY'),
	(NULL, 'prs', 'PRIMARY', 'prs', 'permission', 'PRIMARY KEY'),
	(NULL, 'prs', 'PRIMARY', 'prs', 'product', 'PRIMARY KEY'),
	(NULL, 'prs', 'fk_product_purchase1', 'prs', 'product', 'FOREIGN KEY'),
	(NULL, 'prs', 'PRIMARY', 'prs', 'purchase', 'PRIMARY KEY'),
	(NULL, 'prs', 'fk_purchase_funds_nature1', 'prs', 'purchase', 'FOREIGN KEY'),
	(NULL, 'prs', 'fk_purchase_pruchase_activity1', 'prs', 'purchase', 'FOREIGN KEY'),
	(NULL, 'prs', 'PRIMARY', 'prs', 'purchase_activity', 'PRIMARY KEY'),
	(NULL, 'prs', 'PRIMARY', 'prs', 'purchase_attach_file', 'PRIMARY KEY'),
	(NULL, 'prs', 'fk_purchase_attach_file_purchase1', 'prs', 'purchase_attach_file', 'FOREIGN KEY'),
	(NULL, 'prs', 'PRIMARY', 'prs', 'role', 'PRIMARY KEY'),
	(NULL, 'prs', 'fk_role_permission1', 'prs', 'role', 'FOREIGN KEY'),
	(NULL, 'prs', 'fk_role_user1', 'prs', 'role', 'FOREIGN KEY'),
	(NULL, 'prs', 'PRIMARY', 'prs', 'user', 'PRIMARY KEY'),
	(NULL, 'prs', 'fk_user_dept', 'prs', 'user', 'FOREIGN KEY');
...
-- 正在导出表  information_schema.TABLE_PRIVILEGES 的数据：-1 rows
...
-- 正在导出表  information_schema.TRIGGERS 的数据：-1 rows
...
-- 正在导出表  information_schema.USER_PRIVILEGES 的数据：-1 rows
...
-- 正在导出表  information_schema.VIEWS 的数据：-1 rows
...
REPLACE INTO `help_category` (`help_category_id`, `name`, `parent_category_id`, `url`) VALUES
	(1, 'Geographic', 0, ''),
...
-- 正在导出表  mysql.help_keyword 的数据：453 rows
/*!40000 ALTER TABLE `help_keyword` DISABLE KEYS */;
REPLACE INTO `help_keyword` (`help_keyword_id`, `name`) VALUES
	(0, 'JOIN'),
	(1, 'HOST'),
	(2, 'REPEAT'),
	(3, 'SERIALIZABLE'),
...
-- 正在导出表  mysql.help_relation 的数据：1,009 rows
/*!40000 ALTER TABLE `help_relation` DISABLE KEYS */;
REPLACE INTO `help_relation` (`help_topic_id`, `help_keyword_id`) VALUES
	(1, 0),
	(357, 0),
	(475, 1),
	(234, 2),
...
-- 正在导出表  mysql.help_topic 的数据：510 rows
/*!40000 ALTER TABLE `help_topic` DISABLE KEYS */;
REPLACE INTO `help_topic` (`help_topic_id`, `name`, `help_category_id`, `description`, `example`, `url`) VALUES
	...
	(191, 'HELP_VERSION', 9, 'This help information was generated from the MySQL 5.1 Reference Manual\non: 2013-11-04 (revision: 36590)\n\nThis information applies to MySQL 5.1 through 5.1.74.\n', '', ''),
	...
	(202, 'MPOLYFROMTEXT', 3, 'MPolyFromText(wkt[,srid]), MultiPolygonFromText(wkt[,srid])\n\nConstructs a MULTIPOLYGON value using its WKT representation and SRID.\n\nURL: http://dev.mysql.com/doc/refman/5.1/en/creating-spatial-values.html\n\n', '', 'http://dev.mysql.com/doc/refman/5.1/en/creating-spatial-values.html'),
	(203, 'MBRINTERSECTS', 6, 'MBRIntersects(g1,g2)\n\nReturns 1 or 0 to indicate whether the Minimum Bounding Rectangles of\nthe two geometries g1 and g2 intersect.\n\nURL: http://dev.mysql.com/doc/refman/5.1/en/functions-for-testing-spatial-relations-between-geometric-objects.html\n\n', '', 'http://dev.mysql.com/doc/refman/5.1/en/functions-for-testing-spatial-relations-between-geometric-objects.html'),
	(204, 'BIT_OR', 16, 'Syntax:\nBIT_OR(expr)\n\nReturns the bitwise OR of all bits in expr. The calculation is\nperformed with 64-bit (BIGINT) precision.\n\nURL: http://dev.mysql.com/doc/refman/5.1/en/group-by-functions.html\n\n', '', 'http://dev.mysql.com/doc/refman/5.1/en/group-by-functions.html'),
	(205, 'YEARWEEK', 32, 'Syntax:\nYEARWEEK(date), YEARWEEK(date,mode)\n\nReturns year and week for a date. The mode argument works exactly like\nthe mode argument to WEEK(). The year in the result may be different\nfrom the year in the date argument for the first and the last week of\nthe year.\n\nURL: http://dev.mysql.com/doc/refman/5.1/en/date-and-time-functions.html\n\n', 'mysql> SELECT YEARWEEK(\'1987-01-01\');\n        -> 198653\n', 'http://dev.mysql.com/doc/refman/5.1/en/date-and-time-functions.html'),
	(206, 'NOT BETWEEN', 19, 'Syntax:\nexpr NOT BETWEEN min AND max\n\nThis is the same as NOT (expr BETWEEN min AND max).\n\nURL: http://dev.mysql.com/doc/refman/5.1/en/comparison-operators.html\n\n', '', 'http://dev.mysql.com/doc/refman/5.1/en/comparison-operators.html'),
	(207, 'IS NOT', 19, 'Syntax:\nIS NOT boolean_value\n\nTests a value against a boolean value, where boolean_value can be TRUE,\nFALSE, or UNKNOWN.\n\nURL: http://dev.mysql.com/doc/refman/5.1/en/comparison-operators.html\n\n', 'mysql> SELECT 1 IS NOT UNKNOWN, 0 IS NOT UNKNOWN, NULL IS NOT UNKNOWN;\n        -> 1, 1, 0\n', 'http://dev.mysql.com/doc/refman/5.1/en/comparison-operators.html'),
...
REPLACE INTO `user` (`Host`, `User`, `Password`, `Select_priv`, `Insert_priv`, `Update_priv`, `Delete_priv`, `Create_priv`, `Drop_priv`, `Reload_priv`, `Shutdown_priv`, `Process_priv`, `File_priv`, `Grant_priv`, `References_priv`, `Index_priv`, `Alter_priv`, `Show_db_priv`, `Super_priv`, `Create_tmp_table_priv`, `Lock_tables_priv`, `Execute_priv`, `Repl_slave_priv`, `Repl_client_priv`, `Create_view_priv`, `Show_view_priv`, `Create_routine_priv`, `Alter_routine_priv`, `Create_user_priv`, `Event_priv`, `Trigger_priv`, `ssl_type`, `ssl_cipher`, `x509_issuer`, `x509_subject`, `max_questions`, `max_updates`, `max_connections`, `max_user_connections`) VALUES
	('localhost', 'root', '*032197AE5731D4664921A6CCAC7CFCE6A0698693', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', _binary '', _binary '', _binary '', 0, 0, 0, 0);
...
-- 正在导出表  prs.approve_record 的数据：~9 rows (大约)
...
REPLACE INTO `approve_record` (`id`, `user_id`, `purchase_id`, `opinion`, `purchase_activity_id`, `approve_date`) VALUES
	(1, 2, 1, '', 3, '2016-10-08'),
	(5, 2, 2, '', 3, '2016-10-08'),
	(6, 3, 2, 'rewqrqw', 4, '2016-10-08'),
	(7, 7, 2, '333333333333333333', 5, '2016-10-08'),
	(8, 12, 2, '', 6, '2016-10-08'),
	(9, 2, 5, '', 3, '2016-10-08'),
	(10, 3, 5, '', 4, '2016-10-08'),
	(11, 7, 5, '', 5, '2016-10-08'),
	(12, 12, 5, '', 6, '2016-10-08');
...
CREATE TABLE IF NOT EXISTS `package` (
  ...
  `package_address` varchar(45) DEFAULT NULL COMMENT '采购地点',
  `pur_date` varchar(45) DEFAULT NULL COMMENT '采购日期',
  `expert_count` varchar(45) DEFAULT NULL COMMENT '抽取专家人数',
  `pur_method` varchar(45) DEFAULT NULL COMMENT '采购方式',
  `publicity` varchar(45) DEFAULT NULL COMMENT '采购需求公告',
  `vendor` varchar(45) DEFAULT NULL COMMENT '中标供应商',
  `amount` varchar(45) DEFAULT NULL COMMENT '中标金额',
...
REPLACE INTO `product` (`id`, `uuid`, `type`, `name`, `count`, `purchase_id`, `price`, `spec`, `pre_price`, `param`, `packaged_count`) VALUES
	...
	(2, 'EMhIuzziJWI3KgJiP3QOXvGpGPkwvl1FGDem', '商品类', '1', 10, 5, 1, '1', 1, '1', 0),
	(3, 'pnXKU4bLhkd0U3XLWYGRAFU3Houm7ORuRsfI', '商品类', '2', 20, 5, 2, '2', 2, '2', 0);
...
CREATE TABLE IF NOT EXISTS `purchase` (
  ...
  `purchase_activity_id` int(11) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
...
-- 正在导出表  prs.purchase 的数据：~5 rows (大约)
/*!40000 ALTER TABLE `purchase` DISABLE KEYS */;
REPLACE INTO `purchase` (`id`, `code`, `purchase_uuid`, `name`, `funds_src`, `funds_nature_id`, `contacts`, `phone_num`, `purchase_activity_id`) VALUES
	(1, '1', '9ykpvsVhKguP8HQWB1Wovbuet8S8lUCLwV3d', NULL, '3233333', 1, '1', '1', 3),
	(2, '2', 'bVUbtIacBmyEutfBhtXR1JQcKOaxgnLlsdTH', NULL, 'fdfsafdsaf', 1, '1', '1', 6),
	(4, '4', '1NDtNRdmptESekhrZhHfb4uz88lSwm6a04Oz', NULL, '4', 2, '4', '4', 2),
	(5, '5', 'IsS30KvYimp6qoKe6KDxHPeJaHcqRznI9eKs', NULL, 'a', 1, 'a', '', 6),
	(6, '6', 'yIhMckK3MUawdhbZkFm0ao9Zcpro5kB9JW4G', NULL, '', 1, '', '', 1);
