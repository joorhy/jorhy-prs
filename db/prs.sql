...
-- 正在导出表  information_schema.CHARACTER_SETS 的数据：36 rows
...
-- 正在导出表  information_schema.COLLATIONS 的数据：129 rows
...
-- 正在导出表  information_schema.COLLATION_CHARACTER_SET_APPLICABILITY 的数据：130 rows
...
-- 正在导出表  information_schema.COLUMNS 的数据：608 rows
...
REPLACE INTO `COLUMNS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `COLUMN_NAME`, `ORDINAL_POSITION`, `COLUMN_DEFAULT`, `IS_NULLABLE`, `DATA_TYPE`, `CHARACTER_MAXIMUM_LENGTH`, `CHARACTER_OCTET_LENGTH`, `NUMERIC_PRECISION`, `NUMERIC_SCALE`, `CHARACTER_SET_NAME`, `COLLATION_NAME`, `COLUMN_TYPE`, `COLUMN_KEY`, `EXTRA`, `PRIVILEGES`, `COLUMN_COMMENT`) VALUES
	...
	(NULL, 'prs', 'product', 'packaged_count', 11, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', '已分包数量'),
	...
	(NULL, 'prs', 'purchase', 'purchase_activity_id', 9, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
...
-- 正在导出表  information_schema.COLUMN_PRIVILEGES 的数据：0 rows
...
-- 正在导出表  information_schema.ENGINES 的数据：8 rows
...
-- 正在导出表  information_schema.EVENTS 的数据：0 rows
...
-- 正在导出表  information_schema.FILES 的数据：0 rows
...
-- 正在导出表  information_schema.GLOBAL_STATUS 的数据：291 rows
...
REPLACE INTO `GLOBAL_STATUS` (`VARIABLE_NAME`, `VARIABLE_VALUE`) VALUES
	...
	('BINLOG_CACHE_USE', '0'),
	('BYTES_RECEIVED', '158299'),
	('BYTES_SENT', '1387393'),
	('COM_ADMIN_COMMANDS', '2999'),
	...
	('COM_SHOW_TABLE_STATUS', '17'),
	('COM_SHOW_TABLES', '0'),
	('COM_SHOW_TRIGGERS', '17'),
	('COM_SHOW_VARIABLES', '172'),
	('COM_SHOW_WARNINGS', '0'),
	('COM_SLAVE_START', '0'),
	('COM_SLAVE_STOP', '0'),
	('COM_STMT_CLOSE', '0'),
	...
	('COMPRESSION', 'OFF'),
	('CONNECTIONS', '170'),
	('CREATED_TMP_DISK_TABLES', '538'),
	('CREATED_TMP_FILES', '5'),
	('CREATED_TMP_TABLES', '1798'),
	('DELAYED_ERRORS', '0'),
	...
	('INNODB_BUFFER_POOL_PAGES_FLUSHED', '493'),
	('INNODB_BUFFER_POOL_PAGES_FREE', '12991'),
	('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
	('INNODB_BUFFER_POOL_PAGES_TOTAL', '13120'),
	('INNODB_BUFFER_POOL_READ_AHEAD_RND', '2'),
	('INNODB_BUFFER_POOL_READ_AHEAD_SEQ', '0'),
	('INNODB_BUFFER_POOL_READ_REQUESTS', '32519'),
	('INNODB_BUFFER_POOL_READS', '26'),
	('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
	('INNODB_BUFFER_POOL_WRITE_REQUESTS', '7197'),
	('INNODB_DATA_FSYNCS', '348'),
	('INNODB_DATA_PENDING_FSYNCS', '0'),
	('INNODB_DATA_PENDING_READS', '0'),
	('INNODB_DATA_PENDING_WRITES', '0'),
	('INNODB_DATA_READ', '4280320'),
	('INNODB_DATA_READS', '138'),
	('INNODB_DATA_WRITES', '787'),
	('INNODB_DATA_WRITTEN', '16595456'),
	('INNODB_DBLWR_PAGES_WRITTEN', '493'),
	('INNODB_DBLWR_WRITES', '54'),
	('INNODB_LOG_WAITS', '0'),
	('INNODB_LOG_WRITE_REQUESTS', '698'),
	('INNODB_LOG_WRITES', '204'),
	('INNODB_OS_LOG_FSYNCS', '240'),
	('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
	('INNODB_OS_LOG_PENDING_WRITES', '0'),
	('INNODB_OS_LOG_WRITTEN', '422400'),
	('INNODB_PAGE_SIZE', '16384'),
	('INNODB_PAGES_CREATED', '0'),
	('INNODB_PAGES_READ', '128'),
	('INNODB_PAGES_WRITTEN', '493'),
	...
	('INNODB_ROWS_READ', '271'),
	('INNODB_ROWS_UPDATED', '14'),
	('KEY_BLOCKS_NOT_FLUSHED', '0'),
	('KEY_BLOCKS_UNUSED', '6682'),
	('KEY_BLOCKS_USED', '16'),
	...
	('THREADS_RUNNING', '1'),
	('UPTIME', '44200'),
	('UPTIME_SINCE_FLUSH_STATUS', '44200');
...
-- 正在导出表  information_schema.GLOBAL_VARIABLES 的数据：279 rows
...
-- 正在导出表  information_schema.KEY_COLUMN_USAGE 的数据：78 rows
...
-- 正在导出表  information_schema.PARTITIONS 的数据：66 rows
...
REPLACE INTO `PARTITIONS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `PARTITION_NAME`, `SUBPARTITION_NAME`, `PARTITION_ORDINAL_POSITION`, `SUBPARTITION_ORDINAL_POSITION`, `PARTITION_METHOD`, `SUBPARTITION_METHOD`, `PARTITION_EXPRESSION`, `SUBPARTITION_EXPRESSION`, `PARTITION_DESCRIPTION`, `TABLE_ROWS`, `AVG_ROW_LENGTH`, `DATA_LENGTH`, `MAX_DATA_LENGTH`, `INDEX_LENGTH`, `DATA_FREE`, `CREATE_TIME`, `UPDATE_TIME`, `CHECK_TIME`, `CHECKSUM`, `PARTITION_COMMENT`, `NODEGROUP`, `TABLESPACE_NAME`) VALUES
	(NULL, 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16434816, 0, 0, '2016-09-23 21:22:31', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2016-09-23 21:22:31', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16357770, 0, 0, '2016-09-23 21:22:31', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-09-23 21:22:31', '2016-09-23 21:22:31', NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2016-09-23 21:22:31', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16574250, 0, 0, '2016-09-23 21:22:31', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-09-23 21:22:31', '2016-09-23 21:22:31', NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2016-09-23 21:22:31', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2016-09-23 21:22:31', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2016-09-23 21:22:31', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2016-09-23 21:22:31', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-09-23 21:22:31', '2016-09-23 21:22:31', NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-09-23 21:22:31', '2016-09-23 21:22:31', NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-09-23 21:22:31', '2016-09-23 21:22:31', NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2016-09-23 21:22:31', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2016-09-23 21:22:31', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-09-23 21:22:31', '2016-09-23 21:22:31', NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16738048, 0, 0, '2016-09-23 21:22:31', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16736899, 0, 0, '2016-09-23 21:22:31', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2016-09-23 21:22:31', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2016-09-23 21:22:31', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2679, 0, 16770540, 0, 0, '2016-09-23 21:22:31', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3545, 0, 16743035, 0, 0, '2016-09-23 21:22:31', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16721712, 0, 0, '2016-09-23 21:22:31', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2016-09-23 21:22:31', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-09-23 21:22:31', '2016-09-23 21:22:31', NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16726092, 0, 0, '2016-09-23 21:22:31', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-09-23 21:22:31', '2016-09-23 21:22:31', NULL, NULL, '', '', NULL),
	...
	(NULL, 'prs', 'approve_record', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 49152, 11534336, '2016-09-08 16:21:14', NULL, NULL, NULL, '', '', NULL),
	...
	(NULL, 'prs', 'package_product', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2016-09-23 21:22:15', NULL, NULL, NULL, '', '', NULL),
	...
	(NULL, 'prs', 'product', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 16384, 11534336, '2016-09-09 09:47:59', NULL, NULL, NULL, '', '', NULL),
	(NULL, 'prs', 'purchase', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 32768, 11534336, '2016-09-09 14:25:17', NULL, NULL, NULL, '', '', NULL),
	...
	(NULL, 'prs', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 14, 1170, 16384, NULL, 16384, 0, '2016-07-08 13:53:31', NULL, NULL, NULL, '', '', NULL);
...
-- 正在导出表  information_schema.PLUGINS 的数据：10 rows
...
REPLACE INTO `PROCESSLIST` (`ID`, `USER`, `HOST`, `DB`, `COMMAND`, `TIME`, `STATE`, `INFO`) VALUES
	(12, 'root', 'localhost:63435', 'prs', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST` LIMIT 104857600');
...
-- 正在导出表  information_schema.PROFILING 的数据：0 rows
...
-- 正在导出表  information_schema.REFERENTIAL_CONSTRAINTS 的数据：18 rows
...
REPLACE INTO `REFERENTIAL_CONSTRAINTS` (`CONSTRAINT_CATALOG`, `CONSTRAINT_SCHEMA`, `CONSTRAINT_NAME`, `UNIQUE_CONSTRAINT_CATALOG`, `UNIQUE_CONSTRAINT_SCHEMA`, `UNIQUE_CONSTRAINT_NAME`, `MATCH_OPTION`, `UPDATE_RULE`, `DELETE_RULE`, `TABLE_NAME`, `REFERENCED_TABLE_NAME`) VALUES
	(NULL, 'prs', 'fk_approve_record_pruchase_activity1', NULL, 'prs', NULL, 'NONE', 'NO ACTION', 'NO ACTION', 'approve_record', 'purchase_activity'),
	...
	(NULL, 'prs', 'fk_purchase_pruchase_activity1', NULL, 'prs', NULL, 'NONE', 'NO ACTION', 'NO ACTION', 'purchase', 'purchase_activity'),
...
-- 正在导出表  information_schema.ROUTINES 的数据：0 rows
...
-- 正在导出表  information_schema.SCHEMATA 的数据：4 rows
...
-- 正在导出表  information_schema.SCHEMA_PRIVILEGES 的数据：0 rows
...
-- 正在导出表  information_schema.SESSION_STATUS 的数据：291 rows
...
REPLACE INTO `SESSION_STATUS` (`VARIABLE_NAME`, `VARIABLE_VALUE`) VALUES
	...
	('BINLOG_CACHE_DISK_USE', '0'),
	('BINLOG_CACHE_USE', '0'),
	('BYTES_RECEIVED', '59228'),
	('BYTES_SENT', '1153127'),
	('COM_ADMIN_COMMANDS', '3032'),
	('COM_ASSIGN_TO_KEYCACHE', '0'),
	('COM_ALTER_DB', '0'),
	('COM_ALTER_DB_UPGRADE', '0'),
	('COM_ALTER_EVENT', '0'),
	...
	('COM_SHOW_COLUMN_TYPES', '0'),
	('COM_SHOW_CONTRIBUTORS', '0'),
	('COM_SHOW_CREATE_DB', '87'),
	('COM_SHOW_CREATE_EVENT', '0'),
	('COM_SHOW_CREATE_FUNC', '0'),
	('COM_SHOW_CREATE_PROC', '0'),
	('COM_SHOW_CREATE_TABLE', '192'),
	('COM_SHOW_CREATE_TRIGGER', '0'),
	('COM_SHOW_DATABASES', '9'),
	('COM_SHOW_ENGINE_LOGS', '0'),
	('COM_SHOW_ENGINE_MUTEX', '0'),
	...
	('COMPRESSION', 'OFF'),
	('CONNECTIONS', '170'),
	('CREATED_TMP_DISK_TABLES', '226'),
	('CREATED_TMP_FILES', '5'),
	('CREATED_TMP_TABLES', '671'),
	('DELAYED_ERRORS', '0'),
	('DELAYED_INSERT_THREADS', '0'),
	('DELAYED_WRITES', '0'),
	('FLUSH_COMMANDS', '1'),
	...
	('HANDLER_DISCOVER', '0'),
	('HANDLER_PREPARE', '0'),
	('HANDLER_READ_FIRST', '117'),
	('HANDLER_READ_KEY', '103'),
	('HANDLER_READ_NEXT', '1009'),
	('HANDLER_READ_PREV', '0'),
	('HANDLER_READ_RND', '0'),
	('HANDLER_READ_RND_NEXT', '6355'),
	('HANDLER_ROLLBACK', '11'),
	('HANDLER_SAVEPOINT', '0'),
	('HANDLER_SAVEPOINT_ROLLBACK', '0'),
	('HANDLER_UPDATE', '14'),
	...
	('INNODB_BUFFER_POOL_READ_AHEAD_RND', '2'),
	('INNODB_BUFFER_POOL_READ_AHEAD_SEQ', '0'),
	('INNODB_BUFFER_POOL_READ_REQUESTS', '33256'),
	('INNODB_BUFFER_POOL_READS', '26'),
	('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
	('INNODB_BUFFER_POOL_WRITE_REQUESTS', '7197'),
	('INNODB_DATA_FSYNCS', '348'),
	...
	('THREADS_RUNNING', '1'),
	('UPTIME', '44201'),
	('UPTIME_SINCE_FLUSH_STATUS', '44201');
...
-- 正在导出表  information_schema.SESSION_VARIABLES 的数据：279 rows
...
-- 正在导出表  information_schema.STATISTICS 的数据：81 rows
...
REPLACE INTO `STATISTICS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `NON_UNIQUE`, `INDEX_SCHEMA`, `INDEX_NAME`, `SEQ_IN_INDEX`, `COLUMN_NAME`, `COLLATION`, `CARDINALITY`, `SUB_PART`, `PACKED`, `NULLABLE`, `INDEX_TYPE`, `COMMENT`) VALUES
	...
	(NULL, 'prs', 'approve_record', 0, 'prs', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'approve_record', 1, 'prs', 'fk_approve_record_user1_idx', 1, 'user_id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'approve_record', 1, 'prs', 'fk_approve_record_purchase1_idx', 1, 'purchase_id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'approve_record', 1, 'prs', 'fk_approve_record_pruchase_activity1_idx', 1, 'purchase_activity_id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
	...
	(NULL, 'prs', 'product', 0, 'prs', 'PRIMARY', 1, 'id', 'A', 1, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'product', 1, 'prs', 'fk_product_purchase1_idx', 1, 'purchase_id', 'A', 1, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'purchase', 0, 'prs', 'PRIMARY', 1, 'id', 'A', 2, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'purchase', 1, 'prs', 'fk_purchase_funds_nature1_idx', 1, 'funds_nature_id', 'A', 2, NULL, NULL, '', 'BTREE', ''),
	(NULL, 'prs', 'purchase', 1, 'prs', 'fk_purchase_pruchase_activity1_idx', 1, 'purchase_activity_id', 'A', 2, NULL, NULL, '', 'BTREE', ''),
...
-- 正在导出表  information_schema.TABLES 的数据：66 rows
...
REPLACE INTO `TABLES` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `TABLE_TYPE`, `ENGINE`, `VERSION`, `ROW_FORMAT`, `TABLE_ROWS`, `AVG_ROW_LENGTH`, `DATA_LENGTH`, `MAX_DATA_LENGTH`, `INDEX_LENGTH`, `DATA_FREE`, `AUTO_INCREMENT`, `CREATE_TIME`, `UPDATE_TIME`, `CHECK_TIME`, `TABLE_COLLATION`, `CHECKSUM`, `CREATE_OPTIONS`, `TABLE_COMMENT`) VALUES
	(NULL, 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16434816, 0, 0, NULL, '2016-09-23 21:22:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
	(NULL, 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2016-09-23 21:22:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
	(NULL, 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16357770, 0, 0, NULL, '2016-09-23 21:22:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
	(NULL, 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-09-23 21:22:31', '2016-09-23 21:22:31', NULL, 'utf8_general_ci', NULL, 'max_rows=9690', ''),
	(NULL, 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2016-09-23 21:22:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
	(NULL, 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16574250, 0, 0, NULL, '2016-09-23 21:22:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
	(NULL, 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-09-23 21:22:31', '2016-09-23 21:22:31', NULL, 'utf8_general_ci', NULL, 'max_rows=1315', ''),
	(NULL, 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2016-09-23 21:22:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
	(NULL, 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2016-09-23 21:22:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
	(NULL, 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2016-09-23 21:22:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
	(NULL, 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2016-09-23 21:22:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
	(NULL, 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-09-23 21:22:31', '2016-09-23 21:22:31', NULL, 'utf8_general_ci', NULL, 'max_rows=11927', ''),
	(NULL, 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-09-23 21:22:31', '2016-09-23 21:22:31', NULL, 'utf8_general_ci', NULL, 'max_rows=27679', ''),
	(NULL, 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-09-23 21:22:31', '2016-09-23 21:22:31', NULL, 'utf8_general_ci', NULL, 'max_rows=50785', ''),
	(NULL, 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2016-09-23 21:22:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
	(NULL, 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2016-09-23 21:22:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
	(NULL, 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-09-23 21:22:31', '2016-09-23 21:22:31', NULL, 'utf8_general_ci', NULL, 'max_rows=1250', ''),
	(NULL, 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16738048, 0, 0, NULL, '2016-09-23 21:22:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
	(NULL, 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16736899, 0, 0, NULL, '2016-09-23 21:22:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
	(NULL, 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2016-09-23 21:22:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
	(NULL, 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2016-09-23 21:22:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
	(NULL, 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2679, 0, 16770540, 0, 0, NULL, '2016-09-23 21:22:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6262', ''),
	(NULL, 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3545, 0, 16743035, 0, 0, NULL, '2016-09-23 21:22:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4732', ''),
	(NULL, 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16721712, 0, 0, NULL, '2016-09-23 21:22:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
	(NULL, 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2016-09-23 21:22:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
	(NULL, 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-09-23 21:22:31', '2016-09-23 21:22:31', NULL, 'utf8_general_ci', NULL, 'max_rows=1210', ''),
	(NULL, 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16726092, 0, 0, NULL, '2016-09-23 21:22:31', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
	(NULL, 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-09-23 21:22:31', '2016-09-23 21:22:31', NULL, 'utf8_general_ci', NULL, 'max_rows=14732', ''),
	...
	(NULL, 'prs', 'approve_record', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 49152, 11534336, 1, '2016-09-08 16:21:14', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
	...
	(NULL, 'prs', 'product', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 16384, 11534336, 2, '2016-09-09 09:47:59', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
	(NULL, 'prs', 'purchase', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 32768, 11534336, 3, '2016-09-09 14:25:17', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
...
-- 正在导出表  information_schema.TABLE_CONSTRAINTS 的数据：57 rows
...
-- 正在导出表  information_schema.TABLE_PRIVILEGES 的数据：0 rows
...
-- 正在导出表  information_schema.TRIGGERS 的数据：0 rows
...
-- 正在导出表  information_schema.USER_PRIVILEGES 的数据：27 rows
...
-- 正在导出表  information_schema.VIEWS 的数据：0 rows
...
-- 正在导出表  mysql.general_log 的数据：0 rows
...
-- 正在导出表  mysql.slow_log 的数据：0 rows
...
REPLACE INTO `purchase` (`id`, `code`, `purchase_uuid`, `name`, `funds_src`, `funds_nature_id`, `contacts`, `phone_num`, `purchase_activity_id`) VALUES
	(1, '1', '9ykpvsVhKguP8HQWB1Wovbuet8S8lUCLwV3d', NULL, '1', 1, '1', '1', 0),
	(2, '1', 'bVUbtIacBmyEutfBhtXR1JQcKOaxgnLlsdTH', NULL, '1', 1, '1', '1', 0);
